//
//  AmplitudeServiceTableViewController.swift
...
final class AmplitudeServiceTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    private let service: AmplitudeService
    
    private let operation: Operation
    
    init(service: AmplitudeService, for operation: Operation) {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .credentials:
            ...
            cell.titleLabel.text = LocalizedString("API Key", comment: "The title of the Amplitude API key")
            cell.textField.text = service.apiKey
